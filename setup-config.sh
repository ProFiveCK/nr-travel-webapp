...
case $ENVIRONMENT in
  ...
  docker)
    ...
    ;;
  production)
    echo "⚠️  Production mode - using existing .env values"
...
echo "✏️  Updating .env file..."
{
  ...
  echo "SMTP_USERNAME=hidden@example.com"
  echo "SMTP_PASSWORD=REDACTED"
  echo "SMTP_FROM=travel@naurufinance.info"
  echo ""
...
if [ "$ENVIRONMENT" = "development" ]; then
  echo "✏️  Creating .env for frontend development..."
